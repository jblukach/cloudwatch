...
class CloudwatchAlarmUse1(Stack):
    ...
    ### SNS TOPIC ###
        ...
        topic = _sns.Topic(
            self, 'topic',
            topic_name = 'ErrorAlarmUSE1',
            display_name = 'ErrorAlarmUSE1'
        )
    ...
    ### ERRORS ALARM ###
        ...
        alarm = _cw.Alarm(
            self, 'alarm',
            alarm_name = 'ErrorAlarmUSE1',
            alarm_description = 'USE1 Alarm for Lambda Errors',
            metric = errors,
            threshold = 1,
