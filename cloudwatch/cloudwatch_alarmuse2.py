...
class CloudwatchAlarmUse2(Stack):
    ...
    ### SNS TOPIC ###
        ...
        topic = _sns.Topic(
            self, 'topic',
            topic_name = 'ErrorAlarmUSE2',
            display_name = 'ErrorAlarmUSE2'
        )
    ...
    ### ERRORS ALARM ###
        ...
        alarm = _cw.Alarm(
            self, 'alarm',
            alarm_name = 'ErrorAlarmUSE2',
            alarm_description = 'USE2 Alarm for Lambda Errors',
            metric = errors,
            threshold = 1,
