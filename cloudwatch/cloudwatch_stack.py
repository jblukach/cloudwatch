...
class CloudwatchStack(Stack):
    ...
    ### SNS TOPIC ###
        ...
        topic = _sns.Topic(
            self, 'topic',
            topic_name = 'ErrorsAlarm',
            display_name = 'ErrorsAlarm'
        )
    ...
    ### ERRORS ALARM ###
        ...
        alarm = _cw.Alarm(
            self, 'alarm',
            alarm_name = 'ErrorsAlarm',
            alarm_description = 'Global Alarm for Lambda Errors',
            metric = errors,
            threshold = 1,
    ...
    ### OIDC ###
        ...
        github = _iam.Role(
            ...
            assumed_by = _iam.WebIdentityPrincipal(provider.open_id_connect_provider_arn).with_conditions(
                {
                    "StringLike": {
                        "token.actions.githubusercontent.com:sub": "repo:jblukach/cloudwatch:*"
                    }
                }
            )
        )
